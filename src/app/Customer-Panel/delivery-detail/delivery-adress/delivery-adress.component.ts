...
export class DeliveryAdressComponent implements OnInit {
 ...
 options: Options = {
  ...
  componentRestrictions: { country: this.getCountryCode() }  // Restrict to Australia
};
...
getCountryCode(){
 const formData:any =  localStorage.getItem('formValue');
 const parsedFormData=JSON.parse(formData)
this.storedCountry=parsedFormData.countryCode
